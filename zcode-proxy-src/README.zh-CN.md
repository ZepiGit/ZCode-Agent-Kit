...
> **Kit 内嵌说明：** 本目录是 ZCode-Agent-Kit 内嵌（vendored）的 zcode-proxy，来自上游
> [TriDefender/zcode-api](https://github.com/TriDefender/zcode-api) v4.6.4（固定版本、提交与本地改动见
> [`../MANIFEST.md`](../MANIFEST.md)，本地补丁见 [`../patches/`](../patches/)）。
...
docker run -d --name zcode-proxy -p 8080:8080 \
  ...
  -e ZCODE_PROXY_CREDENTIAL_SECRET="***" \
