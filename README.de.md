...
`update` stoppt den Proxy, bevor es Dateien anfasst, und startet ihn danach neu — wenn der Befehl zurückkehrt, läuft der Proxy mit dem aktualisierten Code. Bleibe beim Aktualisieren bei derselben Installationsmethode.
