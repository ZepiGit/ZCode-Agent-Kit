...
export function findBundledProviderConfig(harnessPath: string): string | null {
...
function appServerEnv(cwd: string, bundledProviderConfigPath: string | null | undefined): NodeJS.ProcessEnv {
...
export function spawnAppServer(opts: { harnessPath: string; cwd: string; bundledProviderConfigPath?: string | null }): ChildProcessWithoutNullStreams {
