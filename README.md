...
`update` stops the proxy before it touches files and restarts it afterwards — when the command returns, the proxy is running the updated code. Keep the same installation method when updating.
