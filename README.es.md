...
`update` detiene el proxy antes de tocar archivos y lo reinicia después — cuando el comando termina, el proxy ejecuta el código actualizado. Conserva el mismo método de instalación al actualizar.
